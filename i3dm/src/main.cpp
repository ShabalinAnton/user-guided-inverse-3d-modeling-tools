...
void display(Viewport &viewport, TriangleMesh &reference, TriangleMesh &quadric) {
...
{
	Viewport viewport;
	TriangleMesh inputMesh, quadricMesh;
	...
	// fit quadric
	vector<Quadric> qfits;
	fitAllQuadricTypes(inputMesh, qfits);
	vector<TriangleMesh> meshes; meshes.resize(qfits.size());
